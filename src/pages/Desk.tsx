                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex justify-center sm:justify-start gap-4 text-sm">
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground mb-3">
                      © 2024. D.K Park. All rights reserved.
                    </p>
                  </div>
                  ...
                  <Collapsible open={isTechStackOpen} onOpenChange={setIsTechStackOpen} className="mt-4">
                    ...
                    <CollapsibleContent className="mt-3 space-y-3">
                      ...
                      <div className="space-y-3">
                        <span className="text-sm font-medium text-muted-foreground">The Note Stacks made with:</span>
                        <div className="space-y-2">
                          {techStackCategories.map((category) => (
                            <div
                              key={category.category}
                              className="flex flex-wrap items-center gap-2 border border-border rounded-lg p-2 transition-colors duration-200 hover:bg-accent/10 hover:border-accent/30"
                            >
